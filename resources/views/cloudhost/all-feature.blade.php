        ...
        <div class="container">
            <div class="row align-items-center text-left">
                <div class="col-md-7 col-12">
                    ...
                    <p class="pb-4 text-white mt-0">We provide reliable, fast and secure Web hosting services with Premium
        ...
        <div class="container higher-index-2">
            ...
            <div class="row">
                <div class="col-md-6 ml-auto mr-auto text-center">
                    <h1 class="display-2 mb-4">Plans and Features Compare Plans</h1>
                                    ...
                                    <table class="table table-pricing">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">
                                                <p class="lead font-weight-bold">Premium Plan</p>
                                                <div class="display-2 d-flex justify-content-center "> <span class="font-weight-bold ">{{ number_format(2500) }}</span> <span
                                                        class="font-weight-400 pt-3 text-left" style="font-size: 18px; line-height: 1;">XAF <br />
                              Monthly</span></div>
                                                <ul class="list-unstyled my-2">
                                                    <li class="align-items-center mb-2">
                                                        Renews at <strong>{{ number_format(5000) }} <sup style="font-size: 13px;">XAF</sup></strong> monthly
                                                    </li>
                                                    <a target="_blank"
                                                       href="https://www.globexcamhost.com/client/?cmd=cart&action=add&id=3&languagechange={{ (LaravelLocalization::getCurrentLocaleNative()) === 'English' ? 'English' : 'French' }}" class="btn btn-primary btn-round btn-lg w-100">Order Now</a>
                                                </ul>
                                            </th>
                                            <th class="text-center">
                                                <p class="lead font-weight-bold">Ultimate Plan</p>
                                                <div class="display-2 d-flex justify-content-center "> <span class="font-weight-bold ">{{ number_format(5000) }}</span> <span
                                                        class="font-weight-400 pt-3 text-left" style="font-size: 18px; line-height: 1;">XAF <br />
                            Monthly</span></div>
                                                <ul class="list-unstyled my-2">
                                                    <li class="align-items-center mb-2">
                                                        Renews at <strong>{{ number_format(10000) }} <sup style="font-size: 13px;">XAF</sup></strong> monthly
                                                    </li>
                                                    <a target="_blank"
                                                       href="https://www.globexcamhost.com/client/?cmd=cart&action=add&id=4&languagechange={{ (LaravelLocalization::getCurrentLocaleNative()) === 'English' ? 'English' : 'French' }}" class="btn btn-primary btn-round btn-lg w-100">Order Now</a>
                                                </ul>
                                            </th>
                                        </tr>
                                        </thead>
        ...
        <div class="container-fluid mt-5 higher-index-2">
            ...
            <div class="row">
                <div class="col-md-12 mb-4 text-center">
                    <h1 class="display-1 d-none d-md-block text-white"> Choose your Package </h1>
                    <h1 class="mt-6 d-md-none d-block text-white"> Choose your Package</h1>
                    <h2 class="text-white d-none d-md-block">Free Domain for Life name included</h2>
                    <h4 class="text-white d-md-none d-block">Free Domain for Life name included</h4>
                </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-sm-6">
                            <div class="card card-pricing bg-white text-center mb-4">
                                <div class="card-header bg-transparent">
                                    <h5 class="font-weight-bold text-uppercase ls-1 py-3 mb-0"> Premium Plan</h5>
                                </div>
                                <div class="card-body">
                                    <h6 class="text-muted text-center">
                                        <span class="badge badge-pill badge-md badge-success mr-1 text-uppercase">Save 50%</span>
                                        <span>First Year</span>
                                    </h6>
                                    <div class="display-2 d-flex justify-content-center "><span
                                            class="font-weight-bold ">2,500</span>
                      ...
                      Monthly</span></div>
                                    ...
                                    <ul class="list-unstyled my-2">
                                        <li class="align-items-center">
                                            Renews at <strong>5,000 <sup style="font-size: 13px;">XAF</sup></strong>
                                            monthly
                                        </li>
                                        <a href="https://globexcamhost.com/client/?cmd=cart&action=add&id=3&languagechange=English"
                          ...
                          data-content="<p class='my-0 f-8px'>Our friendly and knowledgeable support team is available to help you, just contact support with any issue.</p>"><i
                            ...
                            class="fas text-light fa-info-circle"></i></span>
                                    ...
                                    <a href="{{ route('all-features') }}" type="button"
                                       class="btn btn-link text-primary">See all
                                        Features</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card card-pricing bg-white border-0 text-center mb-4">
                                <div class="card-header bg-transparent">
                                    <h5 class="font-weight-bold text-uppercase ls-1 py-3 mb-0"><i
                                            class="fas fa-thumbs-up text-light"></i> Ultimate Plan</h5>
                                </div>
                                <div class="card-body">
                                    <h6 class="text-muted text-center">
                                        <span class="badge badge-pill badge-md badge-success mr-1">SAVE 50%</span>
                                        <span>First Year</span>
                                    </h6>
                                    <div class="display-2 d-flex justify-content-center "><span
                                            class="font-weight-bold ">5,000</span>
                                        <span class="font-weight-400 pt-3 text-left"
                                              style="font-size: 18px; line-height: 1;">XAF <br/>
                      Monthly</span></div>
                                    <ul class="list-unstyled my-2">
                                        <li class="align-items-center">
                                            Renews at <strong>10,000 <sup style="font-size: 13px;">XAF</sup></strong>
                                            monthly
                                        </li>
                                        <a target="_blank"
                                           href="https://www.globexcamhost.com/client/?cmd=cart&action=add&id=4&languagechange=English"
                                           class="btn btn-primary btn-round btn-lg w-100">Order Now</a>
                                    </ul>
                                </div>
                                <div class="card-footer text-center bg-transparent">
